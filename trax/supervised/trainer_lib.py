...
def _add_weights_and_mask(inputs, id_to_mask):
  ...
  return trax_inputs.Inputs(
      train_stream=lambda n: _mask_stream(inputs.train_stream(n)),
      eval_stream=lambda n: _mask_stream(inputs.eval_stream(n)),
      train_eval_stream=lambda n: _mask_stream(inputs.train_eval_stream(n)))
